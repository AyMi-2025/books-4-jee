...
const BOOKS_DATA = [
    ...
    {
        id: 10,
        title: "PW Class 11th JEE (15 Modules)",
    ...
    {
        id: 11,
        title: "PW Class 12th JEE (15 Modules)",
        author: "Physics Wallah",
        subject: "Physics, Chemistry, Mathematics",
        condition: "Good",
        originalPrice: 990,
...
function openWhatsApp(book) {
    const message = `Hi! I'm interested in buying "${book.title}" by ${book.author} , its listed price on the website is : ₹${book.sellingPrice}`;
